...
MO(_CTL), KC_Z,     KC_X,    KC_C,    KC_V,    KC_B,                  KC_N,       KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, KC_F3,
...
KC_NO,    KC_NO,    KC_NO,   KC_NO,   KC_HOME, KC_END,                KC_BSPC,    KC_DEL,  KC_NO,    KC_NO,   KC_NO,   KC_NO
    ...
    [_CTL] = LAYOUT(
KC_NO,     C(KC_Q), C(KC_W),    C(KC_E),    C(KC_R),    C(KC_T),      C(KC_Y),     C(KC_U),    C(KC_I),    C(KC_O),     C(KC_P),     QK_BOOT,
