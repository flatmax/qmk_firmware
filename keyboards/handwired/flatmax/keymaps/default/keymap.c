...
KC_NO, KC_NO, C(KC_TAB), C(KC_Q), C(KC_W), C(KC_E), C(KC_R), C(KC_T),     KC_EQUAL,  KC_LBRC,   KC_QUOT,     KC_RBRC,  C(KC_P), KC_NO, KC_NO, KC_NO,
KC_NO, KC_NO, KC_NO,     C(KC_A), C(KC_S), C(KC_D), C(KC_F), C(KC_G),     KC_MINUS,  S(KC_9),   KC_UP,       S(KC_0),  KC_NO,   KC_NO, KC_NO, KC_NO,
KC_NO, KC_NO, KC_NO,     C(KC_Z), C(KC_X), C(KC_C), C(KC_V), C(KC_B),     KC_BSLS,   KC_LEFT,   KC_DOWN,     KC_RIGHT, KC_NO,   KC_NO, KC_NO, KC_NO,
...
KC_NO, KC_NO, KC_NO,     KC_NO,   KC_NO,   KC_NO,  C(KC_HOME), C(KC_END), KC_DEL, KC_LSFT,     KC_NO,       KC_NO,    KC_NO,   KC_NO, KC_NO, KC_NO
    ...
    KC_NO, KC_NO, KC_NO,     A(KC_A), A(KC_S), A(KC_D), A(KC_F), A(KC_G),     KC_0,      KC_4,       KC_5,        KC_6,  KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO,     A(KC_Z), A(KC_X), A(KC_C), A(KC_V), A(KC_B),     KC_0,      KC_1,	     KC_2,        KC_3,  KC_NO, KC_NO, KC_NO, KC_NO,
